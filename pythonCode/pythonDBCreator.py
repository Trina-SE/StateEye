...
TESTING_PHASE = True
CRAWL_PATH  = '/Users/fraggen/VisCrawler/Test/gt10/'
LOGS_PATH = '/Users/fraggen/VisCrawler/Test/logs/'
...
def addNearDuplicate(appName, crawl, state1, state2):
	...
	addNDStatement = ('''INSERT INTO nearduplicates VALUES ( 
					 ...
					 '{15}',
					 '{16}',
					 )''').format(appName, crawl, state1, state2, initVal, initVal,initVal, initVal, initVal, initVal, initVal, initVal, initVal, initVal, initVal, "", initVal)
...
def testmultiUpdate():
	...
	#testDB = '/Users/fraggen/VisCrawler/Test/combined.db'
	connectToDB(testDB)
...
def entriesFromFS():
	...
	try:
		...
		for csv in baseCSVs:
			allAvailable=True
			tuples = {}
		# csv = "/Users/fraggen/VisCrawler/Test/gt10/parktherme.at/crawl0/comp_output/crawl0-DOM-RTED-raw-updated.csv"
		# if csv != None:
			# print(csv)
