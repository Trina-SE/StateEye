...
def output_html_doc_dict(templatedir, templateHtml, destination, jsonData, Title='Near Duplicate Detection', saveJsonName=None
	,preLoadedBins = None, crawlPath=None):
	j2_env = Environment(loader=FileSystemLoader(templatedir),
						 trim_blocks=True)
	dict = {"jsonData":jsonData, "title":Title, "saveJsonName":saveJsonName, "preLoadedBins":preLoadedBins, "crawlPath":crawlPath}
	output = ''
	print(dict)
...
def output_html_doc(templatedir, templateHtml, destination, jsonData, Title='Near Duplicate Detection', saveJsonName=None
	...
	output = ''
	print(saveJsonName)
	if preLoadedBins is None:
		if saveJsonName is None :
...
def testJinjaCreator():
	...
	output_html_doc("/HTMLStuff", "/HTMLStuff/testJinja.html", jsonData)
...
def randomPairOuput():
	DB_PATH = "/home/fraggen/gt10_Doms/"
	DB_NAME = "gt10.db"
	CRAWL_PATH = "/home/fraggen/gt10_Doms/"
	RESOURCES = os.path.join(os.path.abspath("/home/fraggen/git/state-abstraction-study/HTMLStuff/resources/"), '')
	TEMPLATE_DIR = os.path.join(os.path.abspath("/home/fraggen/git/state-abstraction-study/HTMLStuff/"), '')
	TEMPLATE_HTML = "jinjaTemplate.html"
	timeString = str(datetime.now().strftime("%Y%m%d-%H%M%S"))
	NUMBER = 500
	OUTPUT_PATH = os.path.join(os.path.abspath("/home/fraggen/htmloutputs/"), "htmloutput_"+ str(NUMBER) + "_"+timeString)
...
def testFailureAnalysis(
	...
	,TEMPLATE_HTML = "regressionAnalysis.html"
	):
	...
	output_html_doc_dict(TEMPLATE_DIR, TEMPLATE_HTML, os.path.join(OUTPUT_PATH, OUTPUT_HTML_NAME), outputJsonString, TITLE,
				saveJsonName=saveJsonName, preLoadedBins=None, crawlPath = crawlPath)


def oracleClassification(
	OUTPUT_PATH
	,OUTPUT_HTML_NAME
	,TITLE
	,outputJson = None
...
if __name__ == '__main__':
	# print("Hello")
	# randomPairOuput();
	# CRAWL_PATH = "/Users/fraggen/git/abstract-state-function-project/src/main/resources/GoldStandards/Petclinic/crawl-petclinic-60min_old"
	# CRAWL_PATH = "/Users/fraggen/git/abstract-state-function-project/src/main/resources/GoldStandards/Addressbook/crawl-addressbook-60min"

	# CRAWL_PATH = "/Users/fraggen/git/abstract-state-function-project/src/main/resources/GoldStandards/Claroline/crawl-claroline-60min"
	# CRAWL_PATH = "/Users/fraggen/git/abstract-state-function-project/src/main/resources/GoldStandards/mantisbt/crawl-mantisbt-60min"
	# CRAWL_PATH = "/Users/fraggen/VisCrawler/testBatch/pagekit/crawl0"
	CRAWL_PATH = "/Users/fraggen/git/comparator-fork/src/main/resources/GoldStandards_hybrid/GoldStandards_hybrid/dimeshift/crawl-dimeshift-60min"
