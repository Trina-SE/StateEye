...
def testNormalizePDiff():
	pDiffRawCSVs = find('*PDiff-raw.csv', '/Users/fraggen/VisCrawler/Test/gt10/')
	totalNormalized = 0
	totalUncalculated = 0
	totalupdated = 0
	totalSynced = 0
	...
	# pDiffRawCSV = "/Users/fraggen/VisCrawler/Test/gt10/windowsvc.com/crawl0/comp_output/crawl0-VISUAL-PDiff-raw.csv"
	# pDiffRawCSV = "/Users/fraggen/VisCrawler/Test/gt10/werner.com/crawl0/comp_output/crawl0-VISUAL-PDiff-raw.csv"
	...
	# if pDiffRawCSV !=None:
		...
		if raw:
			...
			# try:
			# 	testdb = '/Users/fraggen/VisCrawler/Test/gt10.db'
			# 	connectToDB(testdb)
...
def testNormalizeHyst():
	pDiffRawCSVs = find('*Hyst-raw.csv', '/Users/fraggen/VisCrawler/Test/gt10/')
	totalNormalized = 0
	totalUncalculated = 0
	totalupdated = 0
	totalSynced = 0
